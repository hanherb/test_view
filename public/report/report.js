...
function listConsult() {
    ...
    fetch(address + ':3000/graphql', {
        ...
        for(let i = 0; i < data.data.consults.length; i++) {
            let doctor_name = data.data.consults[i].doctor_name;
            let patient_name = data.data.consults[i].patient_name;
            let checkin_date = data.data.consults[i].checkin_date;
            let consult_date = data.data.consults[i].consult_date;
            let status = data.data.consults[i].status;
            if(doctor_name) {
...
function listTransaction() {
    ...
    fetch(address + ':3000/graphql', {
        ...
        for(let i = 0; i < data.data.transactions.length; i++) {
            let patient_name = data.data.transactions[i].patient_name;
            let medicine = data.data.transactions[i].medicine;
            let transaction_date = data.data.transactions[i].transaction_date;
            let price = data.data.transactions[i].price;
...
function listCommerce() {
    ...
    fetch(address + ':3000/graphql', {
        ...
        for(let i = 0; i < data.data.commerces.length; i++) {
            let name = data.data.commerces[i].name;
            let qty = data.data.commerces[i].qty;
            let price = data.data.commerces[i].price;
...
function listSupply() {
    ...
    fetch(address + ':3000/graphql', {
        ...
        for(let i = 0; i < data.data.supplies.length; i++) {
            let supplier_name = data.data.supplies[i].supplier_name;
            let medicine = data.data.supplies[i].medicine;
            let qty = data.data.supplies[i].qty;
            let supply_date = data.data.supplies[i].supply_date;
